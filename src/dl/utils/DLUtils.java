...
public class DLUtils
{
    ...
    /**
    *   this function clears all the blocks from helmets
    *   NOT USED IN ACTUAL RUNTIME
    */
    public static List<ABObject> clearBlocksFromHelmets(List<ABObject> blocks, List<ABObject> pigs)
    {
        ...
        for (int i = 0; i < blocks.size(); ++i)
        {
            ...
            if (block.toString().equals("Poly") 
                && block.type == ABType.Stone
                && block.width <= 24
                && block.height <= 24
                )
            {
    ...
    */
    ...
    /**
    * finds a building structure from the given objects
    * a building consists of recursively touching stones.
    */
    ...
    /**
    *   finds a lonely ranger that does not have any object below or above him in a given x coordinate
    *    NOT USED IN RUNTIME!
    */
    ...
    /**
    *   finds the biggest building from the building given
    *   NOT USED IN RUNTIME!
    */
    ...
    */
    ...
    /**
    *finds only the building structures from the list of objects that contain pigs
    * NOT USED IN RUNTIME!
    */
    public static List<Building> findBuildingsWithPigs(List<ABObject> objs, List<ABObject> pigs)
    {
        ...
        for (Building tmp : blds)
        {
            ...
            for (ABObject pig : pigs)
            {
                if (pig.x >= bld.x && pig.x <= bld.x + bld.width  
                    && pig.y >= bld.y && pig.y <= bld.y + bld.height )
                {
                    ret.add(tmp);
                    break;
                }
    ...
    /**
    * @return true if the released bird is left to all possible objects, false otherwise
    */
    ...
    /**
    * @return true if the released bird is right to all possible objects, false otherwise
    */
    ...
    */
    public static Shot findRandomShot(TrajectoryPlanner tp, Rectangle sling, ABType birdOnSling)
    {
    ...
    /**
    *   performs roullete selection for the metaagent based on the utilities
